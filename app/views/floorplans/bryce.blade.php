...
@section('floorplanname') Bryce @stop
@section('floorplanpdf') http://chesmar.com/sites/chesmar.com/files/elevations/Bryce%20v3.0%20BR%20FLRPLN.pdf @stop
@section('floorplanelevation') http://chesmar.com/sites/chesmar.com/files/elevations/Bryce%20v3.0%20BR%20ELVTN.pdf @stop
...
@section('description')
Single-story home with three bedrooms plus study, two bathrooms, a formal dining room, an eat-in kitchen and breakfast, two-car attached garage, and a covered patio. Open-concept plan features raised ceilings and arched door openings. Private master suite features a tray ceiling and bay window. Backyard features a large covered patio with high ceiling.
@stop

@section('price')  $236,990 @stop
@section('sqft') 1,921 @stop
@section('story') 1 @stop
@section('bath') 2 @stop
@section('bed') 3 @stop
